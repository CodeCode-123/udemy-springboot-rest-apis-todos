...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    private User buildNewUser(RegisterRequest input) {
        ...
        user.setAuthorities(initializeAuthority());
        return user;
    }

    // initialize authority of this user, if there is no users in the database
    // add the ROLE_ADMIN to this user
    private List<Authority> initializeAuthority() {
